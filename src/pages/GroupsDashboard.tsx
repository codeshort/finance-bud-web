       ...
       <div className={styles["group-dashboard-container"]}>
          <GroupExpenseCardList owedAmount={100} lentAmount={200} />
           ...
           <div className={styles["group-dashboard-groups-header"]}>
            ...
            <Button variant={ButtonVariant.SECONDARY} onClick={() => { }} style={{borderColor: "#333333"}}>Filter</Button>
            <Button variant={ButtonVariant.SECONDARY} onClick={() => { }} style={{borderColor: "#333333"}}>Export</Button>
            <Button variant={ButtonVariant.PRIMARY} onClick={() => { }}>Create Group</Button>
            </div>
           </div>
       </div>
    </AppLayout>
